...
export const CreateModal = ({
  ...
  const updateSettings = () => {
    ...
    toast
      .promise(
        BucketApi(hubId).updateCanisterSettings(
  ...
  return (
    ...
    >
      ...
      />
      <div className="bg-white bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-50 w-[600px] min-h-[700px] p-[20px] rounded shadow-lg z-50 snap-none overflow-y-scroll ">
        <div className="modal-content py-4 text-left px-6">
          <div className="flex justify-between items-center pb-[20px]">
            <p className="text-5xl font-medium">
              {isUpdate ? "Update Settings" : "Create Canister"}
            </p>
            <div
          ...
          <form action="#">
            <div
              className={
                isUpdate
                  ? "hidden"
                  : "px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8"
              }
            >
              <div>
