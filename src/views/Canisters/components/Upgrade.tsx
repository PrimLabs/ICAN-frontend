...
export const Upgrade = ({ open, setOpen, hubId, setVersion }: Props) => {
    ...
    xhr.onload = function () {
      if (this.status === 200 || this.status === 304) {
        ...
        reader.onload = async (e) => {
          ...
          console.log(data);
          const res = await ManageApi.intall_code(
            data,
            { upgrade: null },
            Principal.fromText(hubId)
          );
          console.log(res);
          const res1 = await BucketApi(hubId).getVersion();
          setVersion(res1);
          setLoading(false);
          setOpen(false);
        };
  ...
  return (
    <div className="modal-content py-4 text-left px-6">
      <div className="flex justify-between items-center pb-[20px]">
        <p className="text-5xl font-medium">Do you want to upgrade hub ?</p>
        <div
